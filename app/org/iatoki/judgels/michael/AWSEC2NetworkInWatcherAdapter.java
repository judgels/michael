...
import org.iatoki.judgels.michael.views.html.machines.watchers.machineNetworkInWatcherView;
import play.twirl.api.Html;

import java.util.Date;
import java.util.List;

public final class AWSEC2NetworkInWatcherAdapter implements GraphMachineWatcherAdapter {

    private final Machine machine;
    private final AmazonCloudWatch amazonCloudWatch;

    public AWSEC2NetworkInWatcherAdapter(Machine machine, AWSEC2WatcherConf awsec2WatcherConf) {
    ...
    public Html renderWatcher() {
        return machineNetworkInWatcherView.render(machine.getDisplayName() + " - NetworkIn", org.iatoki.judgels.michael.controllers.apis.routes.MachineWatcherAPIController.getDataPoints(machine.getId(), getType().name()).toString(), 60000L);
    }
