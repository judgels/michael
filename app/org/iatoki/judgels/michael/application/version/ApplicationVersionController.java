...
import org.iatoki.judgels.michael.application.ApplicationNotFoundException;
import org.iatoki.judgels.michael.controllers.securities.LoggedIn;
import org.iatoki.judgels.michael.application.version.html.createApplicationVersionView;
import org.iatoki.judgels.michael.application.version.html.listApplicationVersionsView;
...
public final class ApplicationVersionController extends AbstractJudgelsController {
    ...
    public Result listApplicationVersions(long applicationId, long page, String orderBy, String orderDir, String filterString) throws ApplicationNotFoundException {
        ...
        content.appendLayout(c -> tabLayout.render(ImmutableList.of(
              new InternalLink(Messages.get("application.update"), org.iatoki.judgels.michael.application.routes.ApplicationController.updateApplicationGeneral(application.getId())),
